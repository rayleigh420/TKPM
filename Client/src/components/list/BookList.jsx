                ...
                isLoading ?
                    (
                        [...Array(7)].map((item, index) => (
                            <div className='w-[158px] h-[270px] rounded-[7px] cursor-pointer' key={index}>
                                ...
                                <div className="h-1.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[130px] mt-2"></div>
                                <div className="h-1.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[145px] mt-1"></div>
                            </div>
                        ))
                    )
                    :
